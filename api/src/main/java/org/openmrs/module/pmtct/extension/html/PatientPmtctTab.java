 ...
 *
 */
public class PatientPmtctTab extends PatientDashboardTabExt {
	...
	public String getRequiredPrivilege() {
		return "Patient Dashboard - View PMTCT";
	}
	...
	public String getTabName() {
		...
		//    	if(Context.getPatientService().getPatient(Integer.valueOf(patientId)).getGender().compareToIgnoreCase("M")==0)
		//    		return "";
		//    	else 
		return "pmtct.pmtctTitle";
	}
}
